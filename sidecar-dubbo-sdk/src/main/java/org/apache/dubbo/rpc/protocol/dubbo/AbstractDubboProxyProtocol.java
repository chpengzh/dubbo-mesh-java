...
/**
 * DubboProxy客户端Protocol
 *
 * @author chen.pengzhi (chpengzh@foxmail.com)
 */
public abstract class AbstractDubboProxyProtocol extends DubboProtocol {
    ...
    private ExchangeServer createServer(URL url) {
        url = URLBuilder.from(url)
                ...
                .addParameter(CODEC_KEY, getCodecName())
                .build();
    ...
    private ExchangeClient[] getClients(URL url) {
        ...
        if (connections == 0) {
            ...
            connections = Integer.parseInt((shareConnectionsStr == null || shareConnectionsStr.isEmpty())
    ...
    private ExchangeClient initClient(URL url) {
        ...
        url = url.addParameter(CODEC_KEY, getCodecName());
        // enable heartbeat by default
